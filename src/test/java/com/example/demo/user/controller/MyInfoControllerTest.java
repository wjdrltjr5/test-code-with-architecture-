...
class MyInfoControllerTest {
    ...
    void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갖고_올_수_있다() {
        ...
        // when
        ResponseEntity<MyProfileResponse> result = testContainer.myInfoController.get("wjdrltjr@naver.com");
    ...
    void 사용자는_내_정보를_수정할_수_있다() {
        ...
        // when
        ResponseEntity<MyProfileResponse> result = testContainer.myInfoController.update("wjdrltjr@naver.com", UserUpdate.builder()
                .address("Pangyo")
                .nickname("wjdrltjr-n")
                .build());
        ...
        assertThat(result.getBody()).isNotNull();
        assertThat(result.getBody().getEmail()).isEqualTo("wjdrltjr@naver.com");
        assertThat(result.getBody().getNickname()).isEqualTo("wjdrltjr-n");
